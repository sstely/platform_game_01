...
public class Constants {
    ...
    public static final int ANI_SPEED = 25; //120 fps : 4.8 anim per sec
    ...
    public static class Environment {
        ...
        //Playing Background
        public static final int PLAY_BG_WIDTH_DEFAULT = (int)(1536 * 1.7);    //3072
        public static final int PLAY_BG_HEIGHT_DEFAULT = (int)(384 * 1.7);   //768
        public static final int PLAY_BG_WIDTH = (int)(PLAY_BG_WIDTH_DEFAULT * Game.SCALE);
        public static final int PLAY_BG_HEIGHT = (int)(PLAY_BG_HEIGHT_DEFAULT * Game.SCALE);

        //Intro Level
        public static final int RED_MARK_WIDTH_DEFAULT = (int)(64 * 1.65);
        public static final int RED_MARK_WIDTH = (int)(RED_MARK_WIDTH_DEFAULT * Game.SCALE);
        public static final int RED_MARK_HEIGHT_DEFAULT = (int)(176 * 1.65);
        public static final int RED_MARK_HEIGHT = (int)(RED_MARK_HEIGHT_DEFAULT * Game.SCALE);

        public static final int TITLE_HEIGHT_DEFAULT = (int)(24 * 1.65);
        public static final int TITLE_HEIGHT = (int)(TITLE_HEIGHT_DEFAULT * Game.SCALE);

        public static final int BIG_TITLE_1_WIDTH_DEFAULT = (int)(208 * 1.65);
        public static final int BIG_TITLE_1_WIDTH = (int)(BIG_TITLE_1_WIDTH_DEFAULT * Game.SCALE);
        public static final int ZONE_WIDTH_DEFAULT = (int)(72 * 1.65);
        public static final int ZONE_WIDTH = (int)(ZONE_WIDTH_DEFAULT * Game.SCALE);

        public static final int ACT_WIDTH_DEFAULT = (int)(48 * 1.65);
        public static final int ACT_WIDTH = (int)(ACT_WIDTH_DEFAULT * Game.SCALE);
        public static final int ACT_1_HEIGHT_DEFAULT = (int)(32 * 1.65);
        public static final int ACT_1_HEIGHT = (int)(ACT_1_HEIGHT_DEFAULT * Game.SCALE);
        public static final int ACT_2_HEIGHT_DEFAULT = (int)(33 * 1.65);
        public static final int ACT_2_HEIGHT = (int)(ACT_2_HEIGHT_DEFAULT * Game.SCALE);
    }

    public static class UI {
        public static class Buttons {
            public static final int B_WIDTH_DEFAULT = 176; // 176
        ...
        public static class PauseButtons {
            public static final int SOUND_SIZE_DEFAULT = 28;
            public static final int SOUND_SIZE = (int)(SOUND_SIZE_DEFAULT * Game.SCALE);
        }

        public static class URMButtons {
            public static final int URM_DEFAULT_SIZE = 42;
