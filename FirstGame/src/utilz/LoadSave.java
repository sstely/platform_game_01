...
public class LoadSave {
    ...
    //Intro Level
    public static final String BIG_TITLE_1 = "big_title_1.png";
    public static final String RED_MARK = "red_mark.png";
    public static final String ACT_1 = "act_1.png";
    public static final String ACT_2 = "act_2.png";
    public static final String ZONE = "zone_txt.png";

    //Gamestates
    public static final String MENU_BACKGROUND_IMG = "background_menu.png";
    public static final String MENU_BACKGROUND = "menu_background.png";
    public static final String DEMO_LOGO = "demo_logo.png";
    ...
    //Player
    public static final String PLAYER_ATLAS = "shadow_sprite.png";
