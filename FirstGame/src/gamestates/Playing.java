...
public class Playing extends State implements Statemethods{
    ...
    private Rain rain;
    private IntroLevel introLevel;

    private boolean paused = false;

    private int xLvlOffset, yLvlOffset;
    private int leftBorder = (int)(0.40 * Game.GAME_WIDTH);    //0.25    (in case of error)
    private int rightBorder = (int)(0.50 * Game.GAME_WIDTH);   //0.75
    private int topBorder = (int)(0.30 * Game.GAME_HEIGHT);    //0.30
    private int bottomBorder = (int)(0.50 * Game.GAME_HEIGHT); //0.70
    private int maxLvlOffsetX, maxLvlOffsetY;

    private BufferedImage playImg, bigCloud, smallCloud, shipImgs[];
    ...
    public Playing(Game game) {
        ...
        playImg = LoadSave.GetSpriteAtlas(LoadSave.PLAY_BG);
...
//        loadDialogue();
    ...
    private void initClasses() {
        ...
        rain = new Rain();
        introLevel = new IntroLevel(levelManager.getLvlIndex());
    }
...
//            g.drawImage(shipImgs[shipAni], (int) (100 * Game.SCALE) - xLvlOffset, (int) ((288 * Game.SCALE) + shipHeightDelta), (int) (78 * Game.SCALE), (int) (72 * Game.SCALE), null);
        ...
        enemyManager.draw(g, xLvlOffset, yLvlOffset); // before player - so the enemy is behind him
        player.render(g, xLvlOffset, yLvlOffset);
        objectManager.draw(g, xLvlOffset, yLvlOffset);  // after player - so he's behind objects
...
//        drawDialogue(g, xLvlOffset);
    ...
    private void drawBackground(Graphics g) {
        for(int i = 0; i < 4; i++)
            g.drawImage(playImg, i * PLAY_BG_WIDTH - (int)(xLvlOffset * 0.3), - (int)(yLvlOffset * 0.15), PLAY_BG_WIDTH, PLAY_BG_HEIGHT, null);
    }
