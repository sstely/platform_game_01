...
public class GameCompletedOverlay {
    ...
    private void createButtons() {
        quit = new MenuButton(Game.GAME_WIDTH / 2, (int) (217 * Game.SCALE), 2, Gamestate.MENU);
        credit = new MenuButton(Game.GAME_WIDTH / 2, (int) (147 * Game.SCALE), 3, Gamestate.CREDITS);
    }
